...
CREATE TABLE `ogretmen` (
  `TC` varchar(11) CHARACTER SET utf8 NOT NULL,
  `ogretmenAdi` varchar(45) CHARACTER SET utf8 NOT NULL,
  `ogretmenSoyadi` varchar(45) CHARACTER SET utf8 NOT NULL,
  ...
  PRIMARY KEY (`TC`),
  KEY `brans_idx` (`bransKodu`),
  CONSTRAINT `brans` FOREIGN KEY (`bransKodu`) REFERENCES `brans` (`bransKodu`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2018-08-01  0:03:31
